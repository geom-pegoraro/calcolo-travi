...
export default function TraveSchema2D({ L, carichi = [], RA, RB, schemaConfig, onSchemaConfigChange }) {
  ...
  const cfg = schemaConfig || {
    reactionAUp: false,   // false = freccia giù (reazione verso il basso dal vincolo)
    reactionBUp: false,
    extraSupports: [],    // [{ pos: number, up: boolean }]
  }
    ...
    <div style={{ position: 'relative' }}>
      ...
      <svg width="100%" viewBox={`0 0 ${W} ${H}`}
        ...
        {RA != null && (
          <Arrow
            x={padX}
            y={cfg.reactionAUp ? beamY - 5 : beamY + 36}
            up={cfg.reactionAUp}
            color={REACT_C}
        ...
        {RB != null && (
          <Arrow
            x={W - padX}
            y={cfg.reactionBUp ? beamY - 5 : beamY + 36}
            up={cfg.reactionBUp}
            color={REACT_C}
